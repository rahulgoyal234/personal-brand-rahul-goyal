    ...
    try {
      ...
      if (saved) {
        ...
        if (parsed && typeof parsed === 'object') {
          ...
          if (parsed.avatar && (parsed.avatar.includes('avatar_sabbrn.png') || parsed.avatar.includes('avatar_u0ajsb') || parsed.avatar.includes('avatar_sabbrn') || parsed.avatar.includes('photo_srai3m'))) {
            parsed.avatar = PERSONAL_INFO.avatar;
          }
          const merged = { ...PERSONAL_INFO, ...parsed };
          if (!merged.avatar || merged.avatar === '/avatar.jpg' || merged.avatar === '/avatar.png' || merged.avatar.includes('avatar_sabbrn.png') || merged.avatar.includes('avatar_sabbrn') || merged.avatar.includes('photo_srai3m')) {
        ...
        if (response.ok) {
          ...
          if (remoteData) {
            if (remoteData.personalInfo) {
              ...
              if (!mergedInfo.avatar || mergedInfo.avatar === '/avatar.jpg' || mergedInfo.avatar === '/avatar.png') {

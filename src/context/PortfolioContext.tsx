...
const isInvalidAvatar = (avatar: string | undefined): boolean => {
  ...
  if (avatar.includes('varxn2') || avatar.includes('rkdrlt') || avatar.includes('z0fkzz') || avatar.includes('mdxrml')) return false;
    ...
    try {
      ...
      if (saved) {
        ...
        if (parsed && typeof parsed === 'object') {
          ...
          if (
            !parsed.avatar ||
            (typeof parsed.avatar === 'string' && !parsed.avatar.includes('varxn2') && !parsed.avatar.includes('rkdrlt') && !parsed.avatar.includes('mdxrml')) ||
            (typeof parsed.avatar === 'string' && parsed.avatar.includes('z0fkzz')) ||
          ...
          if (
            !merged.avatar ||
            (typeof merged.avatar === 'string' && !merged.avatar.includes('varxn2') && !merged.avatar.includes('rkdrlt') && !merged.avatar.includes('mdxrml')) ||
            (typeof merged.avatar === 'string' && merged.avatar.includes('z0fkzz')) ||
        ...
        if (response.ok) {
          ...
          if (remoteData) {
            if (remoteData.personalInfo) {
              ...
              if (
                !mergedInfo.avatar ||
                (typeof mergedInfo.avatar === 'string' && !mergedInfo.avatar.includes('varxn2') && !mergedInfo.avatar.includes('rkdrlt') && !mergedInfo.avatar.includes('mdxrml')) ||
                (typeof mergedInfo.avatar === 'string' && mergedInfo.avatar.includes('z0fkzz')) ||
